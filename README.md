...
<dependencies>
    <dependency>
        ...
        <version>1.1.3</version> <!-- Replace with the latest version -->
        <scope>test</scope>
    </dependency>
    <dependency>
        <groupId>io.github.jlapugot.chronoguard</groupId>
...
```xml
<properties>
    <chronoguard.version>1.1.3</chronoguard.version>
</properties>
...
**Groovy DSL:**
```groovy
testImplementation 'io.github.jlapugot.chronoguard:chronoguard-junit5:1.1.3' // Replace with the latest version
testImplementation 'io.github.jlapugot.chronoguard:chronoguard-agent:1.1.3' // Replace with the latest version
```
